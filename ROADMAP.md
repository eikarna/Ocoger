...
* [x] **5.2 Commands pane.** `.opencode/commands/*.md` — `core::commands::list_commands` scans name/description frontmatter; list + cursor nav + Esc/q back. Edit/create/delete deferred (needs name-entry modal + atomic write).
